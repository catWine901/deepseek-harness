...
<a id="deepseek-aidsh-page-app-manager"></a>

## `@deepseek-ai/dsh-page-app-manager`

需要：`PROFILE_RUNTIME_SERVICE` · `loader`
...
来源：[`packages/host/page-app-manager/src/types.ts:16`](../packages/host/page-app-manager/src/types.ts)
...
- `@deepseek-ai/dsh-client-ui-page-app-manager`（[`packages/client/ui-page-app-manager/src/index.ts`](../packages/client/ui-page-app-manager/src/index.ts)）
...
- `@deepseek-ai/dsh-page-app-fixture`（[`packages/examples/page-app-fixture/src/index.ts`](../packages/examples/page-app-fixture/src/index.ts)）
...
- `@deepseek-ai/dsh-page-app-profile`（[`packages/boot/page-app-profile/src/index.ts`](../packages/boot/page-app-profile/src/index.ts)）
