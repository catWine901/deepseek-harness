...
export const EVENT_SCOPE_PAGE: Record<string, string> = {
  ...
  'page-app-manager': 'workspace-apps.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  PageAppActivationRequestedEvent: 'event payload contract is owned by packages/host/page-app-manager/src/types.ts',
  PageAppManagerSnapshot: 'manager projection contract is owned by packages/host/page-app-manager/src/types.ts',
  PageAppClientInstanceId: 'client-instance identity contract is owned by packages/host/page-app-manager/src/types.ts',
  PageAppTransactionId: 'transaction identity contract is owned by packages/host/page-app-manager/src/types.ts',
  PageAppInstallSource: 'install-source contract is owned by packages/host/page-app-manager/src/types.ts',
